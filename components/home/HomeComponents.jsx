...
const HomeComponent = () => {
    const [animate, setAnimate] = useState({ scale: 0.8 });
    ...
    return (
        <div className="w-full px-8 ">
            <div className="bg-white pb-24 flex flex-col h-full w-full rounded-b-[48px] justify-between">
            ...
            <AnimatePresence>
                <motion.div
                    className="bg-base-200 flex flex-col h-full w-full rounded-[48px] justify-between"
                    initial={{ scale: 1 }}
                    animate={animate}
                    whileInView={{ scale: 1 }}
